...
internal class SwipeController(private val buttonsActions: SwipeControllerActions) :
    ...
    private fun setTouchListener(
        ...
        recyclerView.setOnTouchListener { v, event ->
            ...
            if (swipeBack) {
                ...
                if (dX > buttonWidth) buttonShowedState = ButtonsState.GONE
                if (buttonShowedState != ButtonsState.GONE) {
