...
class ChatListUserFragment : BaseFragment() {

    private val viewModel: ChatListUserViewModel by viewModel()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chat_list_user, container, false)
    }
    ...
    private fun observerViewModel() {
        ...
        viewModel.chatLiveData.observe(this, Observer {
            recyclerView.adapter = ChatListUserAdapter(it)
        })
